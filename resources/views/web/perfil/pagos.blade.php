...
@section('titulo', 'Mis Métodos de Pago - Medical Supples')
...
<div class="container dashboard-container">
    ...
    <div style="background: var(--white); border-radius: var(--radius-lg); padding: 2rem; box-shadow: var(--shadow-sm); min-height: 50vh;">
        <h1 style="color: var(--gray-900); margin-bottom: 1rem;">Métodos de Pago</h1>
        <p style="color: var(--gray-600);">Esta sección está en desarrollo. Aquí podrás gestionar tus métodos de pago.</p>
    </div>
</div>
@endsection
